...
public class ModelWrapperDisplayList implements IModelCustom {
    ...
    public ModelWrapperDisplayList(String path) {
        this((WavefrontObject) AdvancedModelLoader.loadModel(
    ...
    public ModelWrapperDisplayList(ResourceLocation resourceLocation) {
        this((WavefrontObject) AdvancedModelLoader.loadModel(
                        resourceLocation
                )
        );
